...
Archived and citable: DOI [10.5281/zenodo.21252911](https://doi.org/10.5281/zenodo.21252911) (v1.12, latest deposited version, verified live 2026-07-10) · [10.5281/zenodo.21193846](https://doi.org/10.5281/zenodo.21193846) (**corpus-record** concept DOI — resolves to the latest corpus deposit). Under the dual-license scheme (from v1.13), the **manuscript** gets its **own** concept DOI on its separate CC BY-NC-ND deposit (pending). (The live v1.12 record's title string still reads "v1.8"; correcting it requires a metadata redeposit — pending author.)
