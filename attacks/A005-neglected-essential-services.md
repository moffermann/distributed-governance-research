...
Distributed allocation may favor visible, emotionally salient, local, or low-conflict projects. Essential services often require continuity, universal coverage, risk pooling, or technical standards that cannot depend on monthly attention.

Example:

```text
Local sports projects receive enthusiastic funding.
Less visible disability care, high-cost medical support, preventive maintenance, or emergency reserves remain underfunded.
```

## Recommended resolution path

- Preserve a non-assignable common pool for essential guarantees, macro obligations, emergency reserves, and functions that should not depend on popularity.
- Require Planning Scopes to identify protected essential-service boundaries.
...
- Treat continuity-critical projects differently from one-time discretionary projects.
...
- Does the active scope identify non-assignable essential functions?
