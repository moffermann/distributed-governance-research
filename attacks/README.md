...
2. verify the project locations cited in the file;
3. test the stress scenario against the current architecture;
4. decide whether the recommended path is enough;
5. create a resolution document only after the critique is mature;
6. update the roadmap, indexes, and affected core documents;
7. keep unresolved risks visible.
