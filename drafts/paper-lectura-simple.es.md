...
- **El ahorro no viene de la administración, sino de la entrega:** contabilizando de forma simétrica lo que cada institución gasta en su propia maquinaria (la central en estudios de valor, asignación y licencias; Core v0 en su plataforma y su control), el costo administrativo sale **aproximadamente neutro**. La ventaja de Core v0 es el valor que entrega, no un recorte de gastos generales.
