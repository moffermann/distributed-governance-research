...
- **Funciona mejor, no peor, cuando participa poca gente.** Contra la intuición, la arquitectura rinde *más* con baja participación: la regla por defecto, alimentada por la información de la minoría atenta, dirige el dinero mejor que un planificador central. No exige movilizar a las masas para funcionar —exige un buen diseño por defecto.
