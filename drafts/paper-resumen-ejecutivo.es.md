...
- **La ventaja es el valor entregado, no un ahorro administrativo.** Al contabilizar de forma simétrica el costo de la maquinaria que cada institución opera —la central en estudios de valor, asignación, priorización y licencias; Core v0 en su propia plataforma y su control—, el costo administrativo resulta **aproximadamente neutro**. La eficiencia no proviene de recortar gastos generales, sino de que, a igual presupuesto, llega más valor por cada peso.
