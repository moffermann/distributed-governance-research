...
Remaining country implementation questions include what budget percentage becomes assignable, what remains in the non-assignable common pool, which population is eligible, which formula determines citizen allocation amounts, and which public functions or pilots are opened first.
