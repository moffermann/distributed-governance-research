...
H014 creates no exclusion power. Under [[../../docs/107_REPUTATION_INFORMS_NEVER_EXCLUDES_AND_A038_RESOLUTION|docs/107]], reputation informs funders' choices and never excludes an executor or proponent from being chosen: a low-reputation actor becomes less attractive, never inadmissible, and consequences flow through choices and through law, not through score-triggered platform acts. Control-role admission (H016) is the separate, protocolized boundary.
