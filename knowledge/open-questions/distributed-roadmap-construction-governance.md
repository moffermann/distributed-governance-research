...
Status: recorded design direction defining the target of the pending formalization (this document's question); the tutored-with-distributed-agenda row and the semi-open regime are the two configurations the corpus has not yet treated formally.
