...
- tutored moderator should not approve its own project or a related project;
...
However, it may not be published for execution financing without an identified and accepted responsible executor.
...
For projects that require financed fiscalization, the system may open a phase for fiscalization offers before execution financing.
...
However, a simple rule where the first funded fiscalizer wins is vulnerable to capture. Higher-risk projects require admissibility rules, competition windows, observations, conflict checks, and possibly reputation or eligibility requirements.
...
Paid evidence producers should not need to create new projects to finance their work.

Instead, they may take paid evidence missions associated with the project or control process.
