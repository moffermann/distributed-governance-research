...
|---|---|---|
| Functional layer distribution principle `H001` | Core v0 framing | Needed to prevent the model from treating inherited institutions or policy sectors as indivisible blocks. H001 defines the test for deciding which layers of a function should remain centralized, become hybrid, or become distributed: coercion, rights deprivation, emergency command, legal recognition, macro fiscal stability, funding, execution, evidence, fiscalization, evaluation, and accountability have different risk profiles. |
