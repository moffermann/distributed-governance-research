...
This project exists to develop, attack, refine, and document a theory of distributed governance and functional state architecture.

The objective is not to prove a political position. The objective is to build a coherent theory capable of surviving serious objections.

## Core attitude

We do not protect ideas because we like them. We expose them to criticism because only the surviving parts deserve to become theory.
...
The project should remain open to being wrong. A beautiful idea that fails under critique must be revised or discarded. A weaker but more robust version is preferable to an elegant but fragile theory.
