...
Next review candidate: draft the responsibility matrix by role, including role authority, required disclosures, prohibited conflicts, evidence obligations, decision limits, formal effects, reputation consequences, and audit references.
