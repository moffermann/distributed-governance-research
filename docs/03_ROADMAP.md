...
H001 is aligned: functional distribution is now a functional-layer principle rather than a binary judgment over whole institutions or policy sectors; coercion, rights deprivation, emergency command, legal recognition, macro fiscal stability, funding, execution, evidence, fiscalization, evaluation, and accountability may require different central, hybrid, or distributed architectures inside the same public function.
