...
Next review candidates: the post-manuscript validation program — external expert review using the prepared packets (now reflecting v1.7), calibration of the simulation to participatory-budgeting data, and a bounded tutored pilot with the instrumentation the resolutions already require; and, when the author chooses, a Zenodo version deposit for v1.7.
