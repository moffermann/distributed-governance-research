...
Next review candidate: draft the Audit Event schema diagram, including audit event fields, actor or role, object reference, transition, rule/version, source record, effect, visibility/privacy treatment, and append-only chain.
