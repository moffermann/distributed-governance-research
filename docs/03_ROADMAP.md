...
Next review candidate: draft the Governance Resolution sequence diagram, including decision fields, citizen audit actions, timeout records, appeal or clarification paths where configured, and aggregate observability effects.
