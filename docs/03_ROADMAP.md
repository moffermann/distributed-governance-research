...
Next review candidate: draft the Operating Mode transition diagram, including Closed, Tutored, Semi-open, Open, Suspended, governance resolutions, review timeout resolutions, public authority boundaries, transition criteria, and audit effects.
