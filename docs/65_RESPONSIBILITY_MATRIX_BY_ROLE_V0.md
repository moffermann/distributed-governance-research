...
| Modeler / Designer | Defines technical model, phases, deliverables, budget structure, metrics, evidence needs, affected-party map where required, and phase gates. | Design assumptions, professional or technical basis where relevant, relationship to proposer/executor/fiscalizer, required permits/documents, value and antivalue metrics, affected-party map, phase dependencies. | Cannot self-certify design adequacy, Required Evidence Package completeness, affected-party consultation sufficiency, or design approval scope where independent review is required. Cannot weaken evidence requirements after support/funding without versioning and review. Related design-and-execution actors require disclosure and safeguards. | Project Phase plan, Value Verification Package, Project Evidential Contract, Fulfillment Evidence Needs, Required Evidence Package inputs, Project Legitimacy Profile inputs, Budget Lines, Threshold Policy inputs, design deliverables, MaterialInformationClaims for material assumptions and conditions. | Design-phase acceptance may allow later-phase funds to become releasable only through the relevant phase gate. Weak design, missing affected-party mapping, inadequate readiness evidence, or hidden design limitations may trigger correction, reformulation, rejection, responsibility review, or reputation input. | Designer-role reputation may reflect accepted designs, rework, omissions, phase-gate failures, affected-party mapping failures, hidden limitations, or material corrections after review. | AuditEvents for design submission, phase creation, evidence contract changes, required evidence package input, legitimacy-profile input, material-claim source linkage, phase-gate review, design correction, and accepted/rejected deliverables. |
...
| Fiscalizer | Performs responsible fiscalization, review, or control assignment under protocol-selected or accepted assignment. | Eligibility criteria for this project, conflict declaration, methodology, scope, review budget, assignment acceptance, limitations, evidence sources considered, comparable-project experience, current workload, repeat relationships, and dependency concentration where relevant. | Cannot be selected by executor for responsible control. Cannot hide conflicts, review limitations, unresolved material warnings, repeat relationships, workload limits, or dependency concentration. Cannot create material/legal suspension by itself unless external law grants that authority. Cannot treat unsupported evidence as fulfillment proof. | Fiscalization Offer, Fiscalizer Eligibility and Reputation Profile, Fiscalization Assignment, Fiscalization Report, evidence review notes, finding, correction request, EvaluationRecord support, complaint admissibility/referral support, MaterialInformationClaim updates where findings affect citizen-facing status. | May support disbursement approval, correction requirement, EvaluationRecord, complaint admissibility, systemic pause inside platform, closure classification, responsibility review, material-warning update, replacement, secondary-audit trigger, or reputation input. | Fiscalizer-role reputation may reflect contextual eligibility outcomes, timeliness, completeness, later-confirmed findings, corrected or overturned findings, insufficient reports, weak-evidence handling, conflict issues, hidden limitations, dependency concentration, or poor review. | AuditEvents for offer, eligibility/conflict/profile generation, assignment, report submission, finding, correction, warning update, replacement, secondary audit, and formal effect routing. |
