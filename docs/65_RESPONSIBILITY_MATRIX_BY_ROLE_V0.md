...
|---|---|---|---|---|---|---|---|
| Proposer | Initiates a project proposal, demand-to-project conversion, or reformulation request. | Identity, actor type, related-party relationships, ownership/control relationships where relevant, project purpose, Planning Scope reference, value thesis, initial budget, proposed roles, affected-party assumptions where required. | Cannot self-validate eligibility, lower burden profile, guarantee requirement, evidence requirements, fiscalization requirements, or affected-party legitimacy conditions. Cannot hide related-party relationships or material affected-party exposure. | Project draft, Project Version, disclosures, Value Thesis, initial Budget, Related-Party Conflict declarations, affected-party assumptions, Reformulation Proposal where applicable. | Publication path may open only after validation and threshold checks. Misrepresentation may trigger correction, rejection, complaint review, Responsibility Event, or reputation input. | Proposer-role reputation may be affected by repeated false promises, hidden conflicts, material omissions, hidden affected-party exposure, or successful accountable proposals. | AuditEvents for proposal creation, disclosure changes, project versioning, validation result, reformulation, affected-party disclosure, and related-party review. |
| Modeler / Designer | Defines technical model, phases, deliverables, budget structure, metrics, evidence needs, affected-party map where required, and phase gates. | Design assumptions, professional or technical basis where relevant, relationship to proposer/executor/fiscalizer, required permits/documents, value and antivalue metrics, affected-party map, phase dependencies. | Cannot self-certify design adequacy, Required Evidence Package completeness, or affected-party consultation sufficiency where independent review is required. Cannot weaken evidence requirements after support/funding without versioning and review. Related design-and-execution actors require disclosure and safeguards. | Project Phase plan, Value Verification Package, Project Evidential Contract, Fulfillment Evidence Needs, Required Evidence Package inputs, Project Legitimacy Profile inputs, Budget Lines, Threshold Policy inputs, design deliverables. | Design-phase acceptance may allow later-phase funds to become releasable only through the relevant phase gate. Weak design, missing affected-party mapping, or inadequate readiness evidence may trigger correction, reformulation, rejection, responsibility review, or reputation input. | Designer-role reputation may reflect accepted designs, rework, omissions, phase-gate failures, affected-party mapping failures, or material corrections after review. | AuditEvents for design submission, phase creation, evidence contract changes, required evidence package input, legitimacy-profile input, phase-gate review, design correction, and accepted/rejected deliverables. |
