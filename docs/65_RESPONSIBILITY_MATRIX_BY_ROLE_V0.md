...
|---|---|---|---|---|---|---|---|
| Proposer | Initiates a project proposal, demand-to-project conversion, or reformulation request. | Identity, actor type, related-party relationships, ownership/control relationships where relevant, project purpose, Planning Scope reference, value thesis, initial budget, proposed roles, affected-party assumptions where required, essential-service lane where applicable. | Cannot self-validate eligibility, lower burden profile, guarantee requirement, evidence requirements, fiscalization requirements, affected-party legitimacy conditions, approval labels, essential-service protection treatment, or unresolved material warnings. Cannot hide related-party relationships, material affected-party exposure, approval limitations, protected-floor limits, or pending conditions. | Project draft, Project Version, disclosures, Value Thesis, initial Budget, Related-Party Conflict declarations, MaterialInformationClaims, affected-party assumptions, Essential Service Protection references where applicable, Reformulation Proposal where applicable. | Publication path may open only after validation and threshold checks. Misrepresentation or hidden material approval/protected-floor limits may trigger correction, rejection, complaint review, Responsibility Event, or reputation input. | Proposer-role reputation may be affected by repeated false promises, hidden conflicts, material omissions, hidden affected-party exposure, hidden approval limitations, hidden essential-scope treatment, or successful accountable proposals. | AuditEvents for proposal creation, disclosure changes, project versioning, validation result, material-claim creation/correction, reformulation, affected-party disclosure, essential-scope label, and related-party review. |
| Modeler / Designer | Defines technical model, phases, deliverables, budget structure, metrics, evidence needs, affected-party map where required, and phase gates. | Design assumptions, professional or technical basis where relevant, relationship to proposer/executor/fiscalizer, required permits/documents, value and antivalue metrics, A004 evidence-coverage matrix, affected-party map, phase dependencies. | Cannot self-certify design adequacy, Required Evidence Package completeness, affected-party consultation sufficiency, A004 coverage sufficiency, or design approval scope where independent review is required. Cannot weaken evidence requirements after support/funding without versioning and review. Related design-and-execution actors require disclosure and safeguards. | Project Phase plan, Value Verification Package with coverage status, Project Evidential Contract, Fulfillment Evidence Needs, Required Evidence Package inputs, Project Legitimacy Profile inputs, Budget Lines, Threshold Policy inputs, design deliverables, MaterialInformationClaims for material assumptions and conditions. | Design-phase acceptance may allow later-phase funds to become releasable only through the relevant phase gate. Weak design, missing evidence coverage, missing affected-party mapping, inadequate readiness evidence, or hidden design limitations may trigger correction, reformulation, rejection, responsibility review, or reputation input. | Designer-role reputation may reflect accepted designs, rework, coverage gaps, omissions, phase-gate failures, affected-party mapping failures, hidden limitations, or material corrections after review. | AuditEvents for design submission, phase creation, evidence coverage status, evidence contract changes, required evidence package input, legitimacy-profile input, material-claim source linkage, phase-gate review, design correction, and accepted/rejected deliverables. |
...
| Role | Primary authority | Required disclosures or inputs | Decision limits and prohibited conflicts | Records, evidence, or outputs | Formal effects that may follow | Reputation or responsibility exposure | Audit references |
|---|---|---|---|---|---|---|---|
| Funder | Commits assignable public-purpose resources to an eligible project, phase lane, control package, complaint-review cost, or other authorized vehicle. | Verified identity, available civic wallet/allocation amount, delegation or automatic profile basis where applicable, target object, funding lane, protected-scope label where applicable. | Funding does not prove legitimacy, execution readiness, disbursement approval, fulfillment, or satisfaction of a protected public guarantee. Cannot allocate ordinary civic-wallet funds to a non-assignable protected floor or excluded lane. Committed funds are governed by funding, reformulation, failure, return, reassignment, and closure rules. | Funding Commitment, lane-specific commitment, delegated funding action, automatic-profile action where configured. | Can help reach funding target, control funding threshold, or eligible distributed service lane target. Funds remain conditional until release rules are satisfied. | Funder reputation is generally not formal Core v0 reputation unless abuse, fraud, or role-specific funding manipulation is later defined. | AuditEvents for commitment, reservation, protected-scope label, withdrawal where allowed, reassignment, return, delegated action, and funding state change. |
...
| Automatic Profile Owner | Configures automatic allocation preferences for low-friction participation. | Verified identity, profile selection, active rules, priority relative to delegation, fallback behavior, protected-scope preference where enabled. | Automatic profile cannot override active delegation, project eligibility, phase gates, citizen confirmation rules, protocol limits, non-assignable protected floors, or excluded lanes. | Automatic Allocation Profile, preference configuration, execution trace, underfunded-protected-scope routing where public and allowed. | May create funding commitments only when active rule permits and no higher-priority delegation or blocker applies. | No ordinary formal reputation exposure. | AuditEvents for profile creation, activation, skipped action, funding action, protected-scope routing, deactivation, and fallback use. |
...
|---|---|---|---|---|---|---|---|
| Public Authority / External Authority | Defines or applies legal, regulatory, budgetary, eligibility, tutored, coercive, fiscal, or oversight authority in controlled scopes. | Legal mandate, responsible authority/process, rule/version, review window, timeout policy where applicable, public reason for material decisions, essential-service target or protected-floor basis where applicable. | Cannot be an internal proposer, executor, fiscalizer, evidence producer, delegate, ordinary moderator, or competitor in the same controlled scope. Cannot silently weaken, hide, or reclassify an essential planning target, protected floor, service lane, or reserve/default/non-assignable treatment. Authority action remains external unless country law says otherwise. | Governance Resolution, Administrative Rule Change, Review Timeout Resolution where system-created after silence, external order reference, registry/permit/custody input, legal decision reference, essential-service protection record where applicable. | May approve/reject in tutored review, interpret scope, revise planning targets through public rule-change path, refer, enforce law, or create external legal effects. Platform records visible effects and boundaries. | Public-authority accountability is mostly external/legal/political in Core v0, but platform observability records delays, decisions, reasons, timeouts, and essential-scope changes. | AuditEvents for tutored decisions, timeouts, rule references, protected-floor or target revision, external orders, authority responses, and operating-mode effects. |
