...
|---|---|---|---|---|---|---|---|
| Proposer | Initiates a project proposal, demand-to-project conversion, or reformulation request. | Identity, actor type, related-party relationships, ownership/control relationships where relevant, project purpose, Planning Scope reference, value thesis, initial budget, proposed roles, affected-party assumptions where required. | Cannot self-validate eligibility, lower burden profile, guarantee requirement, evidence requirements, fiscalization requirements, affected-party legitimacy conditions, approval labels, or unresolved material warnings. Cannot hide related-party relationships, material affected-party exposure, approval limitations, or pending conditions. | Project draft, Project Version, disclosures, Value Thesis, initial Budget, Related-Party Conflict declarations, MaterialInformationClaims, affected-party assumptions, Reformulation Proposal where applicable. | Publication path may open only after validation and threshold checks. Misrepresentation or hidden material approval limits may trigger correction, rejection, complaint review, Responsibility Event, or reputation input. | Proposer-role reputation may be affected by repeated false promises, hidden conflicts, material omissions, hidden affected-party exposure, hidden approval limitations, or successful accountable proposals. | AuditEvents for proposal creation, disclosure changes, project versioning, validation result, material-claim creation/correction, reformulation, affected-party disclosure, and related-party review. |
