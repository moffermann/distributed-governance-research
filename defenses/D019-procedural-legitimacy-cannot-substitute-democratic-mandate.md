...
- `docs/34_CORE_V0_SCOPE_FREEZE.md:834` lists the official budget percentage migrated to the system as a country-implementation decision, confirming migration is external law, not platform configuration.
