...
- [[10_FISCALIZATION_EVIDENCE_AND_CONTROL_MODEL#^r57ae0787|docs/10_FISCALIZATION_EVIDENCE_AND_CONTROL_MODEL.md]] states that the system should assume hidden collusion is possible.
- [[10_FISCALIZATION_EVIDENCE_AND_CONTROL_MODEL#^rd9b8ba01|docs/10_FISCALIZATION_EVIDENCE_AND_CONTROL_MODEL.md]] states that the architecture should not depend on perfect conflict detection.
- [[10_FISCALIZATION_EVIDENCE_AND_CONTROL_MODEL#Anti-capture protections|docs/10_FISCALIZATION_EVIDENCE_AND_CONTROL_MODEL.md]] list safeguards: executor does not choose or directly pay, related-party status is declared, false evidence penalties exist, repeated relationships are visible, and supplemental control is capped.
- [[H016-distributed-fiscalization-ecosystem#^r7ffe1099|knowledge/hypotheses/H016-distributed-fiscalization-ecosystem.md]] states that hidden collusion is possible.
- [[H016-distributed-fiscalization-ecosystem#^rfdde35b4|knowledge/hypotheses/H016-distributed-fiscalization-ecosystem.md]] notes that the system cannot perfectly detect every friendship, off-platform payment, repeated relationship, holding-linked dependency, or informal pressure.
- [[65_RESPONSIBILITY_MATRIX_BY_ROLE_V0#^r902e34bf|docs/65_RESPONSIBILITY_MATRIX_BY_ROLE_V0.md]] states that one actor may hold multiple roles only with separate authority, duties, conflicts, records, effects, reputation treatment, and audit references.
- [[65_RESPONSIBILITY_MATRIX_BY_ROLE_V0#^rc8505bdd|docs/65_RESPONSIBILITY_MATRIX_BY_ROLE_V0.md]] records the remaining risk that role accumulation may create practical conflicts even when disclosed.
- [[66_IMPLEMENTABLE_OBJECT_SCHEMA_DRAFT_V0#^r68b92440|docs/66_IMPLEMENTABLE_OBJECT_SCHEMA_DRAFT_V0.md]] requires objects carrying state, authority, responsibility, funding, review, evidence, reputation, or formal effect to reference AuditEvent records.
- [[66_IMPLEMENTABLE_OBJECT_SCHEMA_DRAFT_V0#Value, Evidence, and Evaluation Schemas|docs/66_IMPLEMENTABLE_OBJECT_SCHEMA_DRAFT_V0.md]] defines `VerifiedDiscovery` as able to create reward, reputation input, correction, complaint, responsibility, or disbursement effects after review.
- [[66_IMPLEMENTABLE_OBJECT_SCHEMA_DRAFT_V0#Reputation, Responsibility, and Performance Schemas|docs/66_IMPLEMENTABLE_OBJECT_SCHEMA_DRAFT_V0.md]] defines `ResponsibilityEvent` as reviewed and role-specific, with possible effects on reputation, eligibility, disbursement, correction, revocation, or legal referral.
- [[P007-integrate-or-bound-rule#^r520eddb3|knowledge/principles/P007-integrate-or-bound-rule.md]] classifies this as integration of observability through existing objects — the A014 relationship graph, VerifiedDiscovery, and ResponsibilityEvent — with detection machinery bounded out of Core v0.
